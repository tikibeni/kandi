...
\supervisors{Nea Pirttinen}
\examiners{Emilia Oikarinen}
...
$\rightarrow$ Software development process management $\rightarrow$  Software development methods \\ $\rightarrow$ Agile software development
}}
...
\include{Ch.20_Koordinaatio}
\include{Ch.30_Suunnittelu}
\include{Ch.40_Yksilomuuttujat}
